...
var allowedKeys = new Set(Object.keys(initialKeysState));
function createKeysStream() {
  var downs$ = (0, _rxjs.fromEvent)(document, 'keydown');
  var ups$ = (0, _rxjs.fromEvent)(document, 'keyup');
  return (0, _rxjs.merge)(downs$, ups$).pipe((0, _operators.filter)(function (event) {
    return allowedKeys.has(event.key);
  }), (0, _operators.tap)(function (event) {
    return event.preventDefault();
  }), (0, _operators.groupBy)(function (event) {
    return event.key;
  }), (0, _operators.map)(function (group) {
    return group.pipe((0, _operators.distinctUntilChanged)(function (a, b) {
      return a.key !== b.key;
    }));
  }), (0, _operators.mergeAll)(), (0, _operators.scan)(function (acc, event) {
    var _a;
    return __assign(__assign({}, acc), (_a = {}, _a[event.key] = event.type === 'keydown', _a));
  }, initialKeysState), (0, _operators.startWith)(initialKeysState));
}
},{"rxjs":"../node_modules/rxjs/dist/esm5/index.js","rxjs/operators":"../node_modules/rxjs/dist/esm5/operators/index.js"}],"../src/util/projection.ts":[function(require,module,exports) {
"use strict";
...
},{}],"../src/util/colors.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.COLOR_CODES = void 0;
exports.getRandomColor = getRandomColor;
var COLOR_CODES = Object.freeze(["#FFFF00", "#2AD689", "#F3FF3F", "#0D5C63", "#247B7B", "#44A1A0"]);
exports.COLOR_CODES = COLOR_CODES;
function getRandomColor() {
  var colorIndex = Math.floor(Math.random() * COLOR_CODES.length);
  return COLOR_CODES[colorIndex];
}
},{}],"../src/game/factory.ts":[function(require,module,exports) {
"use strict";
...
function sector(height, walls) {
  return {
    height: height,
    walls: walls
  };
}
function wall(p1, p2, color, portal, texture) {
  if (color === void 0) {
    color = (0, _colors.getRandomColor)();
  }
  if (portal === void 0) {
    portal = null;
  }
...
function portal(sectorId, wallId) {
  return {
    sectorId: sectorId,
    wallId: wallId
  };
}
},{"../util/colors":"../src/util/colors.ts"}],"../src/game/initial-state.ts":[function(require,module,exports) {
"use strict";
...
var initialState = {
  ...
  map: {
    sectors: [(0, _factory.sector)(DEFAULT_HEIGHT, [(0, _factory.wall)((0, _factory.point)(0, 0), (0, _factory.point)(30, 0)), (0, _factory.wall)((0, _factory.point)(30, 0), (0, _factory.point)(30, 20)), (0, _factory.wall)((0, _factory.point)(30, 20), (0, _factory.point)(30, 30), (0, _colors.getRandomColor)(), (0, _factory.portal)(1, 0)), (0, _factory.wall)((0, _factory.point)(30, 30), (0, _factory.point)(30, 50)), (0, _factory.wall)((0, _factory.point)(30, 50), (0, _factory.point)(0, 50)), (0, _factory.wall)((0, _factory.point)(0, 50), (0, _factory.point)(0, 0))]), (0, _factory.sector)(DEFAULT_HEIGHT, [(0, _factory.wall)((0, _factory.point)(40, 0), (0, _factory.point)(50, 0), (0, _colors.getRandomColor)(), (0, _factory.portal)(0, 2)), (0, _factory.wall)((0, _factory.point)(50, 0), (0, _factory.point)(50, 50)), (0, _factory.wall)((0, _factory.point)(50, 50), (0, _factory.point)(40, 50), (0, _colors.getRandomColor)(), (0, _factory.portal)(2, 1)), (0, _factory.wall)((0, _factory.point)(40, 50), (0, _factory.point)(40, 0))]), (0, _factory.sector)(DEFAULT_HEIGHT, [(0, _factory.wall)((0, _factory.point)(60, 50), (0, _factory.point)(60, 30)), (0, _factory.wall)((0, _factory.point)(60, 30), (0, _factory.point)(60, 20), (0, _colors.getRandomColor)(), (0, _factory.portal)(1, 2)), (0, _factory.wall)((0, _factory.point)(60, 20), (0, _factory.point)(60, 0)), (0, _factory.wall)((0, _factory.point)(60, 0), (0, _factory.point)(90, 0)), (0, _factory.wall)((0, _factory.point)(90, 0), (0, _factory.point)(90, 10), (0, _colors.getRandomColor)(), (0, _factory.portal)(2, 12)), (0, _factory.wall)((0, _factory.point)(90, 10), (0, _factory.point)(80, 10), (0, _colors.getRandomColor)(), null, 4), (0, _factory.wall)((0, _factory.point)(80, 10), (0, _factory.point)(80, 20)), (0, _factory.wall)((0, _factory.point)(80, 20), (0, _factory.point)(90, 20)), (0, _factory.wall)((0, _factory.point)(90, 20), (0, _factory.point)(90, 30), (0, _colors.getRandomColor)(), (0, _factory.portal)(1, 0)), (0, _factory.wall)((0, _factory.point)(90, 30), (0, _factory.point)(80, 30)), (0, _factory.wall)((0, _factory.point)(80, 30), (0, _factory.point)(80, 40)), (0, _factory.wall)((0, _factory.point)(80, 40), (0, _factory.point)(90, 40)), (0, _factory.wall)((0, _factory.point)(90, 40), (0, _factory.point)(90, 50), (0, _colors.getRandomColor)(), (0, _factory.portal)(2, 4)), (0, _factory.wall)((0, _factory.point)(90, 50), (0, _factory.point)(60, 50))])]
  }
};
var _default = initialState;
exports.default = _default;
},{"./factory":"../src/game/factory.ts","../util/colors":"../src/util/colors.ts"}],"../src/consts.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.TEXTURE_TILE_WIDTH = exports.TEXTURE_TILE_HEIGHT = exports.TEXTURE_MAP_SCALE = exports.PLAYER_TURN_STEP = exports.PLAYER_SPEED = exports.PERSPECTIVE_WIDTH = exports.PERSPECTIVE_HEIGHT = exports.CANVAS_WIDTH = exports.CANVAS_HEIGHT = void 0;
// CANVAS SIZE CONSTS
var CANVAS_WIDTH = 200;
exports.CANVAS_WIDTH = CANVAS_WIDTH;
var CANVAS_HEIGHT = 200;
exports.CANVAS_HEIGHT = CANVAS_HEIGHT;
var PERSPECTIVE_WIDTH = 800;
exports.PERSPECTIVE_WIDTH = PERSPECTIVE_WIDTH;
var PERSPECTIVE_HEIGHT = 400;
// PLAYER MOVING CONSTS
exports.PERSPECTIVE_HEIGHT = PERSPECTIVE_HEIGHT;
var PLAYER_SPEED = .4;
exports.PLAYER_SPEED = PLAYER_SPEED;
var PLAYER_TURN_STEP = .03;
exports.PLAYER_TURN_STEP = PLAYER_TURN_STEP;
var TEXTURE_MAP_SCALE = 6.4;
exports.TEXTURE_MAP_SCALE = TEXTURE_MAP_SCALE;
var TEXTURE_TILE_WIDTH = 64;
exports.TEXTURE_TILE_WIDTH = TEXTURE_TILE_WIDTH;
var TEXTURE_TILE_HEIGHT = 64;
exports.TEXTURE_TILE_HEIGHT = TEXTURE_TILE_HEIGHT;
},{}],"../src/util/geometry.ts":[function(require,module,exports) {
"use strict";
...
function getLineAngle(line) {
  var a = line.p1.x - line.p2.x;
  var b = line.p1.y - line.p2.y;
...
function movePoint(point, amount, angle, axis) {
  var _a;
  var c = Math.cos(angle);
  var s = Math.sin(angle);
  var newPoint = {
  ...
  return __assign(__assign({}, point), (_a = {}, _a[axis] = newPoint[axis], _a));
}
...
},{}],"../src/game/core/portal.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.hasWallPortal = hasWallPortal;
exports.isPortal = isPortal;
exports.moveAndRotateCamera = moveAndRotateCamera;
exports.moveCameraInRelationToPortal = moveCameraInRelationToPortal;
...
function hasWallPortal(wall) {
  return isPortal(wall.portal);
}
function isPortal(portal) {
  return portal !== null;
}
function moveCameraInRelationToPortal(thisWall, thatWall, camera) {
  var thisWallAngle = (0, _geometry.getLineAngle)(thisWall);
  var thatWallAngle = (0, _geometry.getLineAngle)(thatWall);
  var thisWallCenter = (0, _geometry.getLineCenter)(thisWall);
  var thatWallCenter = (0, _geometry.getLineCenter)(thatWall);
  var angleDiff = thisWallAngle - thatWallAngle;
  var moveX = thisWallCenter.x - thatWallCenter.x;
  var moveY = thisWallCenter.y - thatWallCenter.y;
  return moveAndRotateCamera(camera, moveX, moveY, angleDiff - Math.PI, thatWallCenter);
}
function moveAndRotateCamera(camera, moveX, moveY, moveAngle, center) {
  var movedCamera = __assign(__assign({}, camera), {
    x: camera.x - moveX,
    y: camera.y - moveY
  });
  var newCenter = (0, _geometry.rotatePoint)(movedCamera, center, moveAngle);
  return __assign(__assign(__assign({}, camera), {
    angle: camera.angle + moveAngle
  }), newCenter);
}
},{"../../util/geometry":"../src/util/geometry.ts"}],"../src/game/core/collision.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.willClipTheWall = willClipTheWall;
function area(a, b, c) {
...
function intersect(p1, p2, p3, p4) {
  return _intersect(p1.x, p2.x, p3.x, p4.x) && _intersect(p1.y, p2.y, p3.y, p4.y) && area(p1, p2, p3) * area(p1, p2, p4) <= 0 && area(p3, p4, p1) * area(p3, p4, p2) <= 0;
}
function willClipTheWall(startPoint, endPoint, wall) {
  return intersect(startPoint, endPoint, wall.p1, wall.p2);
}
},{}],"../src/game/interact/move.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.makeSectorBehindPortal = makeSectorBehindPortal;
exports.movePlayer = movePlayer;
exports.movePlayerOnMap = movePlayerOnMap;
exports.movePlayerThroughPortal = movePlayerThroughPortal;
var _portal = require("../core/portal");
var _collision = require("../core/collision");
var _geometry = require("../../util/geometry");
var __assign = void 0 && (void 0).__assign || function () {
  __assign = Object.assign || function (t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
...
function movePlayerOnMap(playerPosition, step, angle, sectorId, sector, map) {
  var newPlayerPosition = movePlayer(playerPosition, step, angle, null);
  var clippedWall = sector.walls.find(function (wall) {
    return (0, _collision.willClipTheWall)(playerPosition, newPlayerPosition, wall);
  });
  if (!clippedWall) {
    return newPlayerPosition;
  }
  if ((0, _portal.isPortal)(clippedWall.portal)) {
    var _a = clippedWall.portal,
      sectorId_1 = _a.sectorId,
      wallId = _a.wallId;
    var wallBehindPortal = map.sectors[sectorId_1].walls[wallId];
    var sectorBehindWall = makeSectorBehindPortal(map, sectorId_1, wallId);
    var playerPositionBehindPortal = movePlayerThroughPortal(playerPosition, clippedWall, wallBehindPortal, sectorId_1);
    return movePlayerOnMap(playerPositionBehindPortal, step, angle - (playerPosition.angle - playerPositionBehindPortal.angle), sectorId_1, sectorBehindWall, map);
  }
  // Move each axis separately to slip along walls
  return _geometry.AXES.reduce(function (playerPosition, axis) {
    var newPlayerPosition = movePlayer(playerPosition, step, angle, axis);
    var hasClippings = sector.walls.some(function (wall) {
      return (0, _collision.willClipTheWall)(playerPosition, newPlayerPosition, wall);
    });
    return hasClippings ? playerPosition : newPlayerPosition;
  }, playerPosition);
}
function makeSectorBehindPortal(map, sectorId, wallId) {
  var sector = map.sectors[sectorId];
  return __assign(__assign({}, sector), {
    walls: sector.walls.filter(function (_, index) {
      return index !== wallId;
    })
  });
}
function movePlayer(playerPosition, step, angle, axis) {
  return __assign(__assign({}, playerPosition), (0, _geometry.movePoint)(playerPosition, step, angle, axis));
}
function movePlayerThroughPortal(playerPosition, thisWall, thatWall, sectorIdBehindPortal) {
  return __assign(__assign(__assign({}, playerPosition), (0, _portal.moveCameraInRelationToPortal)(thisWall, thatWall, playerPosition)), {
    sectorId: sectorIdBehindPortal
  });
}
},{"../core/portal":"../src/game/core/portal.ts","../core/collision":"../src/game/core/collision.ts","../../util/geometry":"../src/util/geometry.ts"}],"../src/game/reducer.ts":[function(require,module,exports) {
"use strict";
...
var _move = require("./interact/move");
...
function movePlayerPosition(player, map, moveSpeed, moveAngle) {
  var playerSector = map.sectors[player.position.sectorId];
  var position = (0, _move.movePlayerOnMap)(player.position, moveSpeed, moveAngle, player.position.sectorId, playerSector, map);
...
function turnPlayer(player, turnAngle) {
  var tpi = 2 * Math.PI;
  var position = __assign(__assign({}, player.position), {
    angle: (player.position.angle + turnAngle + tpi) % tpi
  });
  return __assign(__assign({}, player), {
    position: position
  });
}
function movePlayer(gameState, keysState, deltaMs) {
  var walkSpeed = _consts.PLAYER_SPEED / 16 * deltaMs;
  var turnSpeed = _consts.PLAYER_TURN_STEP / 16 * deltaMs;
  ...
  if (keysState.ArrowDown) {
    playerState = movePlayerPosition(playerState, map, walkSpeed, playerState.position.angle - Math.PI);
  }
  if (keysState.Alt) {
    // Strafe left
    if (keysState.ArrowLeft) {
      playerState = movePlayerPosition(playerState, map, walkSpeed, playerState.position.angle - Math.PI / 2);
    }
    // Strafe right
  ...
  return playerState === player ? gameState : __assign(__assign({}, gameState), {
    player: playerState
  });
}
function reduce(_a, keysState) {
  var time = _a.time,
    state = _a.state;
  var now = Date.now();
  return {
...
function createGameReducer() {
  return (0, _operators.scan)(reduce, {
    time: Date.now(),
    state: _initialState.default
  });
}
},{"rxjs/operators":"../node_modules/rxjs/dist/esm5/operators/index.js","./initial-state":"../src/game/initial-state.ts","../consts":"../src/consts.ts","./interact/move":"../src/game/interact/move.ts"}],"../src/util/render.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.moveTo = exports.lineTo = void 0;
var moveTo = function moveTo(context, _a) {
  var x = _a.x,
    y = _a.y;
  return context.moveTo(x, y);
};
exports.moveTo = moveTo;
var lineTo = function lineTo(context, _a) {
  var x = _a.x,
    y = _a.y;
  return context.lineTo(x, y);
};
exports.lineTo = lineTo;
},{}],"../src/game/view/transformed.ts":[function(require,module,exports) {
"use strict";
...
function renderPlayer(context, _a) {
  var player = _a.player;
  var x = playerPosition.x;
  var y = playerPosition.y;
  context.save();
  context.beginPath();
  (0, _render.moveTo)(context, {
    x: x,
    y: y
  });
  (0, _render.lineTo)(context, {
    x: x + 5,
    y: y
  });
...
function renderMap(context, _a) {
  var map = _a.map,
    player = _a.player;
  var _b = player.position,
    x = _b.x,
    y = _b.y,
    angle = _b.angle;
  ...
  map.sectors.forEach(function (sector) {
    sector.walls.forEach(function (wall) {
      context.save();
      context.beginPath();
      (0, _render.moveTo)(context, (0, _geometry.rotatePoint)({
        x: wall.p1.x - diffX,
        y: wall.p1.y - diffY
      }, playerPosition, -angle));
      (0, _render.lineTo)(context, (0, _geometry.rotatePoint)({
        x: wall.p2.x - diffX,
        y: wall.p2.y - diffY
      }, playerPosition, -angle));
...
function renderPosition(context, _a) {
  var position = _a.player.position;
  var playerAngle = 360 / Math.PI * position.angle / 2;
  var positionText = "(".concat([position.x, position.y, position.z, playerAngle].map(function (n) {
    return n.toFixed(0);
  }).join(', '), ")");
  context.save();
...
},{"../../util/geometry":"../src/util/geometry.ts","../../util/render":"../src/util/render.ts","../../consts":"../src/consts.ts"}],"../src/game/core/numbers.ts":[function(require,module,exports) {
"use strict";
...
function isBetween(bound1, bound2, subject) {
  return bound1 < bound2 ? bound1 <= subject && subject <= bound2 : bound2 <= subject && subject <= bound1;
}
function scale(min, max, rate) {
  var delta = max - min;
  return min + delta * rate;
}
function unscale(num1, num2, subject) {
  return 1 / (num2 - num1) * (subject - num1);
}
},{}],"../src/game/core/raycaster.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.centerRay = centerRay;
exports.crossTheWall = crossTheWall;
exports.isRayCentered = isRayCentered;
exports.isWallInFrontIfCamera = isWallInFrontIfCamera;
exports.rotateWall = rotateWall;
...
function isWallInFrontIfCamera(wall, camera) {
  return wall.p1.y <= camera.y && camera.y <= wall.p2.y;
}
function crossTheWall(ray, wall) {
  ...
  var offset = (0, _numbers.unscale)(wall.p1.y, wall.p2.y, ray.y);
  var distance = (0, _numbers.scale)(wall.p1.x, wall.p2.x, offset) - ray.x;
  if (distance < 0) {
    return null;
  }
  return {
...
function centerRay(ray) {
  return __assign(__assign({}, ray), {
    angle: 0
  });
}
function isRayCentered(ray) {
  return ray.angle === 0;
}
function rotateWall(_a, center, angle) {
  var p1 = _a.p1,
    p2 = _a.p2,
    other = __rest(_a, ["p1", "p2"]);
  return __assign(__assign({}, other), {
    p1: (0, _geometry.rotatePoint)(p1, center, angle),
    p2: (0, _geometry.rotatePoint)(p2, center, angle)
  });
}
},{"./numbers":"../src/game/core/numbers.ts","../../util/geometry":"../src/util/geometry.ts"}],"../src/game/core/color.ts":[function(require,module,exports) {
"use strict";
...
var COLOR_PREG = /#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})/;
function darken(color, amount) {
  var match = COLOR_PREG.exec(color);
  if (match === null) {
    throw new Error("Bad color - ".concat(color));
  }
  return "#".concat(match.slice(1).map(function (hex) {
    return parseInt(hex, 16);
  }).map(function (int) {
    return Math.max(0, int - Math.floor(int / 100 * amount));
  }).map(function (newInt) {
    return newInt.toString(16).padStart(2, '0');
  }).join(''));
}
},{}],"../src/game/core/renderer.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.RENDER_DISTANCE = exports.HEIGHT_RATIO = exports.FOCUS_LENGTH = exports.DEFAULT_FLOOR_COLOR = exports.DEFAULT_CEILING_COLOR = void 0;
exports.renderCeiling = renderCeiling;
exports.renderColumn = renderColumn;
exports.renderFloor = renderFloor;
exports.renderSector = renderSector;
var _consts = require("../../consts");
...
var FOCUS_LENGTH = 0.8;
exports.FOCUS_LENGTH = FOCUS_LENGTH;
var HEIGHT_RATIO = 1.3;
exports.HEIGHT_RATIO = HEIGHT_RATIO;
var RENDER_DISTANCE = 4096;
exports.RENDER_DISTANCE = RENDER_DISTANCE;
var DEFAULT_CEILING_COLOR = '#009aff';
exports.DEFAULT_CEILING_COLOR = DEFAULT_CEILING_COLOR;
var DEFAULT_FLOOR_COLOR = '#2a2a2a';
exports.DEFAULT_FLOOR_COLOR = DEFAULT_FLOOR_COLOR;
function renderPortal(wall, sectors, ray, camera, screenOffset, screenWidth, context, textureImage) {
  var portal = wall.portal;
  if (portal === null || portal === undefined) {
    throw new Error("Wall expected to have portal");
  }
  var sectorId = portal.sectorId,
    wallId = portal.wallId;
  var thatWall = sectors[sectorId].walls[wallId];
  var movedCamera = (0, _portal.moveCameraInRelationToPortal)(wall, thatWall, camera);
  var movedRay = (0, _portal.moveCameraInRelationToPortal)(wall, thatWall, ray);
  renderColumn(sectorId, sectors, movedRay, movedCamera, screenOffset, screenWidth, context, textureImage);
}
function renderColumn(sectorId, sectors, ray, camera, screenOffset, screenWidth, context, textureImage) {
  var currentSector = sectors[sectorId];
  var nearestWall = Infinity;
  for (var _i = 0, _a = currentSector.walls; _i < _a.length; _i++) {
    var wall = _a[_i];
    var rayCross = (0, _raycaster.crossTheWall)(ray, wall);
    if (rayCross === null || rayCross.distance >= nearestWall || rayCross.distance > RENDER_DISTANCE) {
      continue;
    }
    nearestWall = rayCross.distance;
    var lensDistance = rayCross.distance * Math.cos(camera.angle - ray.angle);
    var heightScale = _consts.PERSPECTIVE_HEIGHT / lensDistance;
    var perspectiveHeight = heightScale * (currentSector.height / HEIGHT_RATIO);
    ...
    if ((0, _portal.hasWallPortal)(wall)) {
      var sectorAfterPortal = sectors[wall.portal.sectorId];
      ...
      if (sectorAfterPortal.height < currentSector.height) {
        var portalPerspectiveHeight = heightScale * (sectorAfterPortal.height / HEIGHT_RATIO);
        // render top and bottom parts of wall
        context.save();
        context.beginPath();
        context.fillStyle = (0, _color.darken)(wall.color, Math.sqrt(rayCross.distance) * 6);
        context.fillRect(screenOffset, 0, screenWidth, _consts.PERSPECTIVE_HEIGHT / 2 - portalPerspectiveHeight);
        context.fillRect(screenOffset, _consts.PERSPECTIVE_HEIGHT / 2 + portalPerspectiveHeight, screenWidth, _consts.PERSPECTIVE_HEIGHT / 2 + perspectiveHeight);
        context.closePath();
        context.fill();
        context.restore();
      }
      ...
      // Render wall
      var wallLength = (0, _geometry.getDistanceBetweenPoints)(wall.p1, wall.p2);
      var textureOffset = _consts.TEXTURE_TILE_WIDTH * wall.texture;
      var textureColumnOffset = textureOffset + wallLength * _consts.TEXTURE_MAP_SCALE * rayCross.offset % _consts.TEXTURE_TILE_WIDTH;
      context.drawImage(textureImage, textureColumnOffset, 1, 1, _consts.TEXTURE_TILE_HEIGHT, screenOffset, _consts.PERSPECTIVE_HEIGHT / 2 - perspectiveHeight, 1, perspectiveHeight * 2);
    }
  }
}
function renderSector(context, sectorId, sectors, camera, textureImage) {
  for (var i = 0; i < _consts.PERSPECTIVE_WIDTH; i += 1) {
    var biasedFraction = i / _consts.PERSPECTIVE_WIDTH - 0.5;
    var angle = Math.atan2(biasedFraction, FOCUS_LENGTH) + camera.angle;
    var ray = __assign(__assign({}, camera), {
      angle: angle
    });
    renderColumn(sectorId, sectors, ray, camera, i, 1, context, textureImage);
  }
}
function renderFloor(context, camera, screenOffset, screenWidth, perspectiveHeight) {
  context.save();
  context.beginPath();
  context.fillStyle = DEFAULT_FLOOR_COLOR;
  context.fillRect(screenOffset, _consts.PERSPECTIVE_HEIGHT / 2, screenWidth, _consts.PERSPECTIVE_HEIGHT / 2);
  context.closePath();
  context.fill();
  context.restore();
}
function renderCeiling(context, camera, screenOffset, screenWidth, perspectiveHeight) {
  context.save();
  context.beginPath();
  context.fillStyle = DEFAULT_CEILING_COLOR;
  context.fillRect(screenOffset, 0, screenWidth, _consts.PERSPECTIVE_HEIGHT / 2);
  context.closePath();
  context.fill();
  context.restore();
}
},{"../../consts":"../src/consts.ts","./raycaster":"../src/game/core/raycaster.ts","./color":"../src/game/core/color.ts","./portal":"../src/game/core/portal.ts","../../util/geometry":"../src/util/geometry.ts"}],"../src/game/view/perspective.ts":[function(require,module,exports) {
"use strict";
...
function renderMap(context, _a, textureImage) {
  var map = _a.map,
    player = _a.player;
  (0, _renderer.renderSector)(context, player.position.sectorId, map.sectors, player.position, textureImage);
}
function render(context, game, textureImage) {
  renderMap(context, game, textureImage);
}
},{"../core/renderer":"../src/game/core/renderer.ts"}],"../src/util/image.ts":[function(require,module,exports) {
"use strict";
...
function loadImage(src) {
  return new Promise(function (resolve, reject) {
    ...
    image.onerror = function () {
      return reject(new Error("Unable to load image ".concat(src)));
    };
    image.src = src;
  });
}
},{}],"../src/images/walls.png":[function(require,module,exports) {
module.exports = "/walls.20f13732.png";
},{}],"../src/util/assert.ts":[function(require,module,exports) {
"use strict";
...
var _transformed = _interopRequireDefault(require("./game/view/transformed"));
var _perspective = _interopRequireDefault(require("./game/view/perspective"));
var _image = require("./util/image");
var _consts = require("./consts");
var _walls = _interopRequireDefault(require("./images/walls.png"));
var _assert = require("./util/assert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var textureImage$ = (0, _rxjs.defer)(function () {
  return (0, _image.loadImage)(_walls.default);
});
var generator$ = (0, _rxjs.interval)(0, _rxjs.animationFrameScheduler).pipe((0, _operators.withLatestFrom)((0, _keys.createKeysStream)(), (0, _projection.takeSecond)()));
var reload$ = new _rxjs.Subject();
// for HMR reloading support
if (module.hot) {
  module.hot.accept(function () {
    return reload$.next(null);
  });
}
var prepareCanvasAndGetContext = function prepareCanvasAndGetContext(canvasId, width, height) {
  var element = document.getElementById(canvasId);
  (0, _assert.assert)(element);
  if (element instanceof HTMLCanvasElement) {
    element.width = width;
    element.height = height;
    var context = element.getContext('2d');
    (0, _assert.assert)(context);
...
var transformedContext = prepareCanvasAndGetContext('canvas-transformed', _consts.CANVAS_WIDTH, _consts.CANVAS_HEIGHT);
(0, _assert.assert)(transformedContext);
var perspectiveContext = prepareCanvasAndGetContext('canvas-perspective', _consts.PERSPECTIVE_WIDTH, _consts.PERSPECTIVE_HEIGHT);
(0, _assert.assert)(perspectiveContext);
generator$.pipe((0, _operators.takeUntil)(reload$), (0, _reducer.createGameReducer)(), (0, _operators.combineLatest)(textureImage$)).subscribe(function (_a) {
  var _b = _a[0],
    time = _b.time,
    state = _b.state,
    textureImage = _a[1];
  (0, _transformed.default)(transformedContext, state);
  (0, _perspective.default)(perspectiveContext, state, textureImage);
});
},{"rxjs":"../node_modules/rxjs/dist/esm5/index.js","rxjs/operators":"../node_modules/rxjs/dist/esm5/operators/index.js","./game/keys":"../src/game/keys.ts","./util/projection":"../src/util/projection.ts","./game/reducer":"../src/game/reducer.ts","./game/view/transformed":"../src/game/view/transformed.ts","./game/view/perspective":"../src/game/view/perspective.ts","./util/image":"../src/util/image.ts","./consts":"../src/consts.ts","./images/walls.png":"../src/images/walls.png","./util/assert":"../src/util/assert.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
