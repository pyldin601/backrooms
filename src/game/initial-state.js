...
const initialState: GameStateInterface = {
  ...
  map: {
    sectors: [
      ...
      sector(DEFAULT_HEIGHT, [
        wall(point(40, 20), point(30, 20)),
        wall(point(30, 20), point(60, 20)),
        wall(point(60, 20), point(60, 30), getRandomColor(), portal(2, 1)),
        wall(point(60, 30), point(30, 30)),
      ]),
      sector(DEFAULT_HEIGHT, [
